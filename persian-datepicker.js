...
var API = function () {
    ...
    _createClass(API, [{
        ...
        value: function setDate(unix) {
            ...
            this.model.input.elem.dispatchEvent(new Event('change'));
            return this.model;
        }
    }, {
        key: 'options',
        ...
        value: function _attachEvents() {
            ...
            if (this.model.options.dayPicker.enabled) {
                ...
                $(document).on('click', '#' + that.model.view.id + ' .datepicker-day-view td:not(.disabled)', function () {
                    ...
                    that.model.input.elem.dispatchEvent(new Event('change'));
                });
            }
...
var Toolbox = function () {
    ...
    _createClass(Toolbox, [{
        ...
        value: function _attachEvents() {
            ...
            $(document).on('click', '#' + that.model.view.id + ' .pwt-btn-clear', function () {
                that.model.input.elem.value = '';
                that.model.input.elem.dispatchEvent(new Event('change'));
            });
            $(document).on('click', '#' + that.model.view.id + ' .pwt-btn-close', function () {
                that.model.view.hide();
            });
